...
*   [`final_xgboost_model.pkl`](final_xgboost_model.pkl): O modelo XGBoost otimizado e treinado.
*   [`comparacao_modelos_finais.csv`](comparacao_modelos_finais.csv): Tabela comparativa detalhada de todos os modelos e métricas de avaliação.
